...
const houses = [
  ...
  },
  {
    id: "2",
    description:
      "In the outskirts of Paris, where the splendor of Paris meets the beauty of the French countryside, is this beautiful Parisian farmhouse. Rustic, yet modern, it beckons to those who want to experience the best of both worlds.",
    key: "house-2",
    homeStyle: "Farmhouse",
    location: "Paris",
  ...
  },
  {
    id: "4",
    description:
      "Discover urban living in this stylish Toronto townhouse. Modern design meets comfort in an open-concept layout flooded with natural light. The sleek kitchen, spacious bedrooms, and chic bathrooms offer a perfect blend of functionality and aesthetics. With a private outdoor space and proximity to amenities, this townhouse is your key to a vibrant Toronto lifestyle.",
    key: "house-4",
    homeStyle: "Townhouse",
    location: "Toronto",
  ...
  },  
  {
    id: "7",
    description:
      "Elevate your lifestyle in this luxurious Shanghai penthouse suite. Perched high above the city, the floor-to-ceiling windows provide breathtaking panoramic views of the iconic skyline. This opulent residence boasts spacious, impeccably designed interiors with high-end finishes. The gourmet kitchen, lavish bedrooms, and spa-like bathrooms redefine sophistication. Entertain on the expansive terrace while enjoying the city lights. Situated in a prime location, this penthouse offers exclusive access to Shanghai's cultural, culinary, and entertainment scene, embodying the epitome of refined urban living.",
    key: "house-7",
    homeStyle: "Penthouse",
    location: "Shanghai",
